...
add wave -noupdate -expand -group IF -color Magenta /acc_tb/dut/start
add wave -noupdate -expand -group IF -color Cyan /acc_tb/dut/IF/pixel_out_last
...
add wave -noupdate -group OUT_MEM -radix unsigned /acc_tb/dut/output_MEM/output_valid
add wave -noupdate -group OUT_MEM -radix unsigned /acc_tb/dut/output_MEM/output_rdata
add wave -noupdate -group OUT_MEM -radix unsigned /acc_tb/dut/output_MEM/output_raddr
...
update
WaveRestoreZoom {105393 ps} {452305 ps}
